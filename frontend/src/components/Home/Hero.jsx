  ...
  return (
    <div className="h-screen md:h-[75vh] flex flex-col md:flex-row items-center justify-center">
      <div className="w-full md:w-3/6 flex flex-col items-center md:items-start justify-center">
        <h1 className=" text-4xl md:text-6xl font-semibold text-center text-pink-500 md:text-left">
          Discover Your Next Great Read
        </h1>
        <p className="mt-4 text-xl text-black md:text-left text-center">
        ...
        <div className="mt-8">
          <Link
            to="/all-books"
            className="tex-yellow-100 text-xl md:text-2xl font-semibold border border-pink-500 px-10 py-3 hover:bg-pink-500 text-black hover:text-white rounded-full">
            Discover Books
          </Link>
        </div>
      </div>
